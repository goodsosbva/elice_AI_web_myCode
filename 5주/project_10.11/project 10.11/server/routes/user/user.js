...
router.get("/find", async (req, res, next) => {
  ...
  // 사용자가 이메일에 해당하는 비밀번호 찾기 요청을 하면
  // 이메일에 해당하는 사용자를 디비에서 가져오고,
  // 가져온 사용자의 이메일에 해당하는 데이터의 비밀번호를 랜덤값을 할당
  // 할당해줬으면 그 할당한 랜덤 비밀번호를 이메일에 전송
  // 이메일로 전송 받은 그 계정의 주인의 이메일에 있는 랜덤비밀번호를 입력해서 로그인을 하고,
  // 나중에 패스워드 변경
  ...
  // 이메일을 보낼 이메일
  let myEmail = "goodsosbva@daum.net";
